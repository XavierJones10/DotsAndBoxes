 ...
 * [ComputerPlay]. This sealed type (which does not allow other direct subtypes) ensures that
 * code can be certain to check whether a player is a [ComputerPlay] and allow its moves to be
